...
<head>
    ...
    <title>Pemasaran | SMK SWAKARYA</title>
    <link rel="stylesheet" href="../../style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <?php $pageTitle = "Pemasaran"; ?>
</head>
<body>
    <main class="program-detail-section">
        ...
        <div class="hero-content">
            <h1>Pemasaran</h1>
            <p>
                Jurusan Pemasaran membentuk siswa untuk menjadi tenaga penjualan dan wirausahawan yang menguasai strategi pemasaran digital dan konvensional.
            </p>
        </div>

        <div class="program-content">
            <h2>Tentang Program Pemasaran</h2>
            <p>Siswa akan mempelajari ilmu dasar bisnis, komunikasi, pelayanan pelanggan, hingga teknik menjual dan promosi, baik secara langsung maupun melalui media sosial dan e-commerce. Program ini sangat relevan untuk karir di dunia retail dan bisnis.</p>
            <h3>Prospek Karier:</h3>
            <ul>
                <li>Tenaga Penjualan/Sales Representative</li>
                <li>Digital Marketer Asisten</li>
                <li>Wirausahawan (Pebisnis Muda)</li>
                <li>Merchandiser Retail</li>
            </ul>
        </div>
    </main>
