...
<head>
    ...
    <title>AKL - Akuntansi dan Keuangan Lembaga | SMK SWAKARYA</title>
...
<body>
    <main class="program-detail-section">
        ...
        <div class="hero-content">
            <h1>Akuntansi dan Keuangan Lembaga (AKL)</h1>
            <p>
                AKL membekali siswa dengan kemampuan menyusun laporan keuangan, mengelola administrasi keuangan, dan menguasai aplikasi akuntansi komputer.
            </p>
        </div>

        <div class="program-content">
            <h2>Tentang Program AKL</h2>
            <p>Program keahlian ini mengajarkan prinsip-prinsip akuntansi, perpajakan, dan operasional lembaga keuangan. Siswa akan terampil dalam pembukuan, pengolahan data akuntansi menggunakan software, dan audit sederhana, menjadikannya siap untuk dunia kerja di bidang finansial.</p>
            <h3>Prospek Karier:</h3>
            <ul>
                <li>Staf Akuntansi/Pembukuan</li>
                <li>Auditor Junior</li>
                <li>Teller Bank/Koperasi</li>
